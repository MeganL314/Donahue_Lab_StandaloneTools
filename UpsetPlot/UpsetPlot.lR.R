...
DEG <- read_excel('./Help/Yo-Ting/UpsetPlot/DEFindMarkers_Volcano_ID.xlsx')
...
get_opposite_direction <- function(df, pval_suffix = "_adjpval", pval_threshold = 0.05, fc_suffix = "_logFC", 
  ...
  outfile <- paste0("./Help/Yo-Ting/UpsetPlot/FoldChangeFilter/", csv, ".csv")
...
get_opposite_direction(DEG, fc_threshold = 0.1, csv = "genes_direction_FC_test_05_28_V2_Fake")
...
#### Get Upset data for 
upset_binary_data <- get_upset_data(DEG, fc_threshold = 1, output_csv = "./Help/Yo-Ting/UpsetPlot/FoldChangeFilter/Upset_Summary_p05_FC1_DEFindMarkers_Volcano_ID_test_V1.csv")
...
write.csv(intersection_counts, "./Help/Yo-Ting/UpsetPlot/FoldChangeFilter/intersection_counts.csv", row.names=FALSE)
...
#Plot the UpSet plot
png("./Help/Yo-Ting/UpsetPlot/FoldChangeFilter/upset_plot_p05_FC_1_stackedbarV3.png", width = 8.5, height = 5, units = "in", res = 300)
